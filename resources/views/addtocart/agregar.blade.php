                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('savetocart',['product'=>$product]) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="notes" type="number" step="0.01" class="form-control @error('notes') is-invalid @enderror" name="notes" value="{{ old('notes') }}" autocomplete="notes" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="qtyone" type="number" class="form-control @error('qtyone') is-invalid @enderror" name="qtyone" value="{{ old('qtyone') }}" required autocomplete="qtyone" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="qtytwo" type="number" class="form-control @error('qtytwo') is-invalid @enderror" name="qtytwo" value="{{ old('qtytwo') }}" autocomplete="qtytwo" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="qtythree" type="number" class="form-control @error('qtythree') is-invalid @enderror" name="qtythree" value="{{ old('qtythree') }}" autocomplete="qtythree" autofocus>
